...
//                .get(AddDataViewModel.class);
        ...
        tvInfo.setText("Eliminate wrinkles in your clothes with electrical and steam iron.");
    }
    ...
    private void setDataSprei() {
        ...
        imageAdd4.setOnClickListener(v -> Toast.makeText(IroningActivity.this, "Service is not available!", Toast.LENGTH_SHORT).show());

        imageMinus4.setOnClickListener(v -> Toast.makeText(IroningActivity.this, "Service is not available!", Toast.LENGTH_SHORT).show());
    }

    private void setDataKarpet() {
        tvKarpet.setText(FunctionHelper.rupiahFormat(hargaKarpet));
        imageAdd5.setOnClickListener(v -> Toast.makeText(IroningActivity.this, "Service is not available!", Toast.LENGTH_SHORT).show());

        imageMinus5.setOnClickListener(v -> Toast.makeText(IroningActivity.this, "Service is not available!", Toast.LENGTH_SHORT).show());
    }
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                Toast.makeText(IroningActivity.this, "Please choose the type of goods!", Toast.LENGTH_SHORT).show();
            } else {
...
//                Toast.makeText(IroningActivity.this, "Your entry is being processed, check on the History menu", Toast.LENGTH_SHORT).show();
//                finish();
            }
        });
    }
