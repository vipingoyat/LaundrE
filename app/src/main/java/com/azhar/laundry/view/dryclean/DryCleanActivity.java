...
public class DryCleanActivity extends AppCompatActivity {
    ...
    int hargaKaos = 80, hargaCelana = 120, hargaJaket = 200, hargaSprei = 150, hargaKarpet = 100;
...
//                .get(AddDataViewModel.class);
        ...
        tvInfo.setText("Dry washing is the process of washing clothing using certain chemicals and techniques without water.");
    }
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                Toast.makeText(DryCleanActivity.this, "Please choose the type of goods!", Toast.LENGTH_SHORT).show();
            } else {
...
//                Toast.makeText(DryCleanActivity.this, "Your order is being processed, check in the history menu", Toast.LENGTH_SHORT).show();
//                finish();
            }
        });
    }
