...
//        ImageView imageView = findViewById( R.id.imageCode1 );
//        imageView.setVisibility( View.VISIBLE );
    ...
    public void onDelete(ModelLaundry modelLaundry) {
        ...
        alertDialogBuilder.setMessage("Delete this history?");
        alertDialogBuilder.setPositiveButton("Yes, Delete", (dialogInterface, i) -> {
            int uid = modelLaundry.uid;
            laundryViewModel.deleteDataById(uid);
            Toast.makeText(HistoryActivity.this, "The selected data has been deleted", Toast.LENGTH_SHORT).show();
        });
