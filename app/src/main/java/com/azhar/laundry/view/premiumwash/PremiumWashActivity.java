...
//        addDataViewModel = new ViewModelProvider( (ViewModelStoreOwner) this, ViewModelProvider
...
//                .get(AddDataViewModel.class);
        ...
        tvInfo.setText("Premium Wash offers an exclusive treatment, using chemicals that are environment friendly and service wholeheartedly.");
    }
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                Toast.makeText(PremiumWashActivity.this, "Please choose the type of goods!", Toast.LENGTH_SHORT).show();
            } else {
...
//                Toast.makeText(PremiumWashActivity.this, "Your order is being processed, check in the history menu", Toast.LENGTH_SHORT).show();
//                finish();
            }
        });
    }
